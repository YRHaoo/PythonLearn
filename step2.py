...
try:
    ...
    f = open("/home/yeruihao/Downloads/MySQL上课文件/作业/university/department.txt", "r")
    while True:
        line = f.readline()
    ...
    f = open("/home/yeruihao/Downloads/MySQL上课文件/作业/university/student.txt", "r")
    while True:
        line = f.readline()
        if line:
            line = line.strip("\n")
    ...
    f = open("/home/yeruihao/Downloads/MySQL上课文件/作业/university/exam.txt", "r")
    while True:
        line = f.readline()
        if line:
            line = line.strip("\n")
            ...
            cur.execute(
                "insert into exam(student_ID,exam_name,grade)values(%s,%s,%s)",
